...
public class addLab extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("ADD LAB DETAILS");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        if(error.equals(""))
        {
            String LabName = t1.getText();
            String Block =t2.getText();


            if(DBManager.addLab(LabName,Block)==true)
            {
                JOptionPane.showMessageDialog(this, "Lab added sucessfully");
            }
            else
            {
                JOptionPane.showMessageDialog(this, "This Lab is Allready present");
            }
        }
        else
        {
    ...
    private void resetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetActionPerformed
     ...
     int op = JOptionPane.showConfirmDialog(this, "Are You Sure","Delete",JOptionPane.YES_NO_OPTION);
        ...
        String LabName =t1.getText();
        String Block=t2.getText();
        int x = DBManager.deleteLab(LabName,Block);
        if (x == 1) {
